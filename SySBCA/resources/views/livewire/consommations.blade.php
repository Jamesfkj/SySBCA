<div>
    ...
    <div class="bg-white">
        ...
        <div class="overflow-x-auto">
            ...
            <div class="flex gap-2 items-center p-1 bg-gray-50 border-b border-gray-200">
                <div>
                    <p class="text-blue-900">
                        Veuillez choisir entre FS et ASC pour continuer:
                    </p>
                    <div>
                        <select name="" id="" wire:model.live="type_structure"
                            class="w-48 rounded-full p-1 border border-gray-400 text-blue-900 focus:outline-none focus:ring-teal-700">
                ...
                <div>
                    <p class="text-blue-900"></p>
                        La période est {{ $periode ? $periode : 'non sélectionnée' }}.
                    </p>
                </div>
            </div>
            <div
                            ...
                            @foreach ($medicaments as $medicament)
                                <tr class="odd:bg-white even:bg-blue-50 transition-colors">
                                    ...
                                    <td class="p-0 m-0 border border-gray-200">
                                        <input type="number" wire:model.live="" class="w-full h-full border-0 bg-transparent text-sm text-blue-900
