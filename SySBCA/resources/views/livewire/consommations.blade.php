<div>
    ...
    @endif
    <!-- Barre de chargement -->
    <div wire:loading wire:target="afficherFormulaire,afficherTableau,filtrerParPériode,ajouterConsommation,chargerMedicaments"
        ...
        <h2 class="text-2xl font-semibold text-teal-600">
            ...
            @elseif ($formulaireVisible)
                <span class="flex items-center gap-2">
                    ...
                    <p>Ajouter une consommation<span class="font-semibold text-[18px] text-gray-500"> | {{ Auth::user()->entity['nom'] }}</span></p>
                </span>
            @endif
        </h2>
        <!-- Filtres et boutons -->
    ...
    <div class="bg-white">
        ...
        <button id="toggleButton" onclick="toggleInstructions()"
                ...
                <div id="instructionsDiv" class="overflow-x-auto transition-all duration-300 ease-in-out"
                    ...
                    <div class="gap-2 items-center bg-gray-50 border-b border-gray-200 pb-2 px-4 py-3 rounded-lg shadow-sm">
                        <p class="text-sm text-gray-700">
                            * Filtrer les données de la table en changeant la période et le type de structure entre FS et ASC
                        </p>
                    </div>
                </div>
                    ...
                    <tbody class="text-[16px]">
                        @forelse ($consommations_all as $consommation)
                            <tr class="odd:bg-white even:bg-blue-50 hover:bg-blue-100 transition-colors font-semibold">
                                <td class="border p-2 text-[14px] font-semibold">{{ $consommation->medicament->nom }}</td>
                                <td class="border p-2 text-center">{{ $consommation->qte_dispo_deb_periode ?? '--' }}</td>
                                <td class="border p-2 text-center">{{ $consommation->qte_recu ?? '--' }}</td>
                                <td class="border p-2 text-center text-red-600">{{ $consommation->qte_en_stock ?? '--' }}</td>
                                ...
                                <td class="border p-2 text-center text-red-600">{{ $consommation->stock_securite ?? '--' }}</td>
                                <td class="border p-2 text-center text-red-600">{{ $consommation->cmma ?? '--' }}</td>
                                <td class="border p-2 text-center text-red-600">{{ $consommation->cmd_trim_svt ?? '--' }}</td>
                                <td class="border p-2 text-center text-red-600">{{ $consommation->qte_accordee_pf_district ?? '--' }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="15" class="text-center p-4 text-gray-500">Aucune consommation enregistrée.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        @elseif ($formulaireVisible)
                ...
                <div class="flex justify-between p-2 bg-gray-50 border-b border-gray-200">
                    ...
                    <div class="flex items-center gap-2">
                        <p class="text-blue-900">Veuillez choisir période:</p>
                        <div>
                                    ...
                                    <tr class="odd:bg-white even:bg-blue-50 hover:bg-blue-100 transition-colors">
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="stock_debut_{{ $index }}"
                                                ...
                                                class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                                                   ...
                                                                   @error('consommations.' . $index . '.stk_dsp_deb_trim') !bg-red-100 !border-red-500 !border-2 @enderror" placeholder="Saisir..." min="0"
                                                step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="qte_recu_{{ $index }}"
                                                ...
                                                class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                                                   focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600
                                                                   @error('consommations.' . $index . '.qte_get_in_trim') !bg-red-100 !border-red-500 !border-2 @enderror" placeholder="Saisir..." min="0"
                                                step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="qte_used_{{ $index }}"
                                                ...
                                                class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                                                   focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600
                                                                   @error('consommations.' . $index . '.qte_used') !bg-red-100 !border-red-500 !border-2 @enderror" placeholder="Saisir..." min="0"
                                                step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="nb_beneficiaire_{{ $index }}"
                                                ...
                                                class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                                                   focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600
                                                                   @error('consommations.' . $index . '.nb_beneficiaire') !bg-red-100 !border-red-500 !border-2 @enderror" placeholder="Saisir..." min="0"
                                                step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="perimee_{{ $index }}" oninput="checkInput({{ $index }})"
                                                ...
                                                class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                                                   focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600
                                                                   @error('consommations.' . $index . '.perimee') !bg-red-100 !border-red-500 !border-2 @enderror" placeholder="Saisir..." min="0"
                                                step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="perte_avarie_{{ $index }}" oninput="checkInput({{ $index }})"
                                                ...
                                                class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                                                   focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600
                                                                   @error('consommations.' . $index . '.perte_avarie') !bg-red-100 !border-red-500 !border-2 @enderror" placeholder="Saisir..." min="0"
                                                step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="qte_ret_cameg_{{ $index }}" oninput="checkInput({{ $index }})"
                                                ...
                                                class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                                                   focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600
                                                                   @error('consommations.' . $index . '.qte_ret_cameg') !bg-red-100 !border-red-500 !border-2 @enderror" placeholder="Saisir..." min="0"
                                                step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="nb_jour_rupture_{{ $index }}"
                                                ...
                                                class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                                                   focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600
                                                                   @error('consommations.' . $index . '.nb_jour_rupture') !bg-red-100 !border-red-500 !border-2 @enderror" placeholder="Saisir..." min="0"
                                                step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="qte_stock_fin_trim_{{ $index }}"
                                                ...
                                                class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                                                   focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600
                                                                   @error('consommations.' . $index . '.qte_stock_fin_trim') !bg-red-100 !border-red-500 !border-2 @enderror" placeholder="Saisir..." min="0"
                                                step="1" />
                                        </td>

                                        <td class="border border-gray-200 p-0 m-0 bg-gray-100">
                                            <input type="number" readonly id="stk_de_securite_{{ $index }}"
                                                wire:model.debounce.500ms="consommations.{{ $index }}.stk_de_securite" class="w-full h-full bg-white border-none text-sm text-blue-900 text-center text-[17px] 
                                                                   font-semibold text-red-500" />
                                        </td>

                                        <td class="border border-gray-200 p-0 m-0 bg-gray-100">
                                            <input type="number" readonly id="ccma_{{ $index }}"
                                                wire:model.debounce.500ms="consommations.{{ $index }}.ccma" class="w-full h-full bg-white border-none text-sm text-blue-900 text-center text-[17px] 
                                                                   font-semibold text-red-500" />
                                        </td>

                                        <td class="border border-gray-200 p-0 m-0 bg-gray-100">
                                            <input type="number" readonly id="cmd_trim_svt_{{ $index }}"
                                                wire:model.debounce.500ms="consommations.{{ $index }}.cmd_trim_svt" class="w-full h-full bg-white border-none text-sm text-blue-900 text-center text-[17px] 
                                                                   font-semibold text-red-500" />
                                        </td>
                                    </tr>
                                @endforeach
