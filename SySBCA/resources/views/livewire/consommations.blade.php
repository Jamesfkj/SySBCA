                                    ...
                                    <tr class="odd:bg-white even:bg-blue-50 hover:bg-blue-100 transition-colors">
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="stock_debut_{{ $index }}"
                                                ...
                                                wire:model.debounce.500ms="consommations.{{ $index }}.stk_dsp_deb_trim" class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="qte_used_{{ $index }}"
                                                ...
                                                wire:model.debounce.500ms="consommations.{{ $index }}.qte_used" class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                               focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600"
                                                placeholder="Saisir..." min="0" step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="nb_beneficiaire_{{ $index }}"
                                                ...
                                                wire:model.debounce.500ms="consommations.{{ $index }}.nb_beneficiaire" class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                               focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600"
                                                placeholder="Saisir..." min="0" step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="perimee_{{ $index }}" oninput="checkInput({{ $index }})"
                                                wire:model.debounce.500ms="consommations.{{ $index }}.perimee" class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                               focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600"
                                                placeholder="Saisir..." min="0" step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="perte_avarie_{{ $index }}"
                                                oninput="checkInput({{ $index }})"
                                                wire:model.debounce.500ms="consommations.{{ $index }}.perte_avarie" class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                               focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600"
                                                placeholder="Saisir..." min="0" step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="qte_ret_cameg_{{ $index }}"
                                                oninput="checkInput({{ $index }})"
                                                wire:model.debounce.500ms="consommations.{{ $index }}.qte_ret_cameg" class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                               focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600"
                                                placeholder="Saisir..." min="0" step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="nb_jour_rupture_{{ $index }}"
                                                ...
                                                wire:model.debounce.500ms="consommations.{{ $index }}.nb_jour_rupture" class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                               focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600"
                                                placeholder="Saisir..." min="0" step="1" />
                                        </td>
                                        ...
                                        <td class="p-0 m-0 border border-gray-200">
                                            <input type="number" id="qte_stock_fin_trim_{{ $index }}"
                                                oninput="calculerStockSecurite({{ $index }}), checkInput({{ $index }})"
                                                wire:model.debounce.500ms="consommations.{{ $index }}.qte_stock_fin_trim" class="w-full h-full bg-transparent border-none text-sm text-blue-900 placeholder:text-gray-400 
                                               focus:outline-none focus:ring-0 focus:border-b-2 focus:border-teal-600"
                                                placeholder="Saisir..." min="0" step="1" />
                                        </td>
