...
<body>
    <div class="email-container">
        ...
        <p>
            ...
            et les besoins en médicaments antipaludiques des formations sanitaires et des agents de santé communautaires.
        </p>
        ...
        <div class="btn-wrapper">
            <a href="{{ $lienActivation }}" class="btn" target="_blank" rel="noopener noreferrer">
                Activer mon compte
            </a>
        </div>
